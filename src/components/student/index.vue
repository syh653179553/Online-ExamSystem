...
<template>
  <div id="student">
    <el-row class="padding-50">
      <el-col :span="24">
        <ul class="list">
          <li class="logo"><i class="iconfont el-icon-notebook-2"></i><span>在线考试系统</span></li>
          <li><a href="javascript:;" @click="exam()">我的考试</a></li>
          <li><a href="javascript:;" @click="practice()">章节练习</a></li>
          <li><router-link to="/wrongquestion">易错题</router-link></li>
