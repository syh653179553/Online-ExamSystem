...
<!--      <el-header class="nav-title"><h3>我的考试</h3></el-header>-->
<!--      <el-container class="nav-item">-->
<!--        <el-aside width="200px"><a href="#" class="top-icon el-icon-date"><br/><font style="font-size: 13px">最近考试</font></a></el-aside>-->
<!--        <el-aside width="200px"><a class="top-icon el-icon-alarm-clock"><br/><font style="font-size: 13px">未开始</font></a></el-aside>-->
<!--        <el-aside width="200px"><a class="top-icon el-icon-time"><br/><font style="font-size: 13px">已过期</font></a></el-aside>-->
<!--        </el-container>-->
<!--    </el-container>-->
          ...
          <li class="item" v-for="(item,index) in pagination.records" :key="index">
            <div>
              <el-row :gutter="24">
                ...
                <el-col :span="3">
                  <el-button @click="toExamMsg(item.examCode)" type="primary" plain style="float: right;margin: 20px 20px 5px 10px;">开始考试</el-button>
                </el-col>
...
export default {
  ...
  methods: {
    //获取当前所有考试信息
    getExamInfo() {
      this.$axios(`/api/getexams/${this.pagination.current}/${this.pagination.size}`).then(res => {
