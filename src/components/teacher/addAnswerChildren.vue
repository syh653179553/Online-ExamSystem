      ...
      <div class="box">
        <ul>
          ...
          <li>
            ...
            <span>选择题简单题数量：</span> <el-input type="text" v-model="changeNumberSimply"></el-input>
            <span>选择题一般题数量：</span> <el-input type="text" v-model="changeNumberCommon"></el-input>
            <span>选择题困难题数量：</span> <el-input type="text" v-model="changeNumberDiff"></el-input>
          </li>
          <li>
            <!--<span>填空题数量：</span> <el-input type="text" v-model="fillNumber"></el-input>-->
            <span>填空题简单题数量：</span> <el-input type="text" v-model="fillNumberSimply"></el-input>
            <span>填空题一般题数量：</span> <el-input type="text" v-model="fillNumberCommon"></el-input>
            <span>填空题困难题数量：</span> <el-input type="text" v-model="fillNumberDiff"></el-input>
          </li>
          <li>
            <!--<span>判断题数量：</span> <el-input type="text" v-model="judgeNumber"></el-input>-->
            <span>判断题简单题数量：</span> <el-input type="text" v-model="judgeNumberSimply"></el-input>
            <span>判断题一般题数量：</span> <el-input type="text" v-model="judgeNumberCommon"></el-input>
            <span>判断题困难题数量：</span> <el-input type="text" v-model="judgeNumberDiff"></el-input>
          </li>
          <li>
...
export default {
  data() {
    return {
      ...
      changeNumberSimply:null,//选择题简单题出题数量
      changeNumberCommon:null,//选择题一般题出题数量
      changeNumberDiff:null,//选择题困难题出题数量

      //fillNumber: null, 填空题出题数量
      fillNumberSimply:null,//填空题简单题出题数量
      fillNumberCommon:null,//填空题一般题出题数量
      fillNumberDiff:null,//填空题困难题出题数量

      //judgeNumber: null, 判断题出题数量
      judgeNumberSimply:null,//判断题简单题出题数量
      judgeNumberCommon:null,//判断题一般题出题数量
      judgeNumberDiff:null,//判断题困难题出题数量
    ...
    create() {
      this.$axios({
        ...
        data: {
          ...
          changeNumberSimply:this.changeNumberSimply,
          changeNumberCommon:this.changeNumberCommon,
          changeNumberDiff:this.changeNumberDiff,
          //fillNumber: this.fillNumber,
          fillNumberSimply:this.fillNumberSimply,
          fillNumberCommon:this.fillNumberCommon,
          fillNumberDiff:this.fillNumberDiff,
          //judgeNumber: this.judgeNumber,
          judgeNumberSimply:this.judgeNumberSimply,
          judgeNumberCommon:this.judgeNumberCommon,
          judgeNumberDiff:this.judgeNumberDiff,
