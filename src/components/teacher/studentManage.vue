...
<template>
  <div class="all">
    <el-button type="primary" size="small" @click="outputStudent">导出</el-button>
    <br>
    <br>
    <el-table :data="pagination.records" border>
      <el-table-column fixed="left" prop="studentId" label="学生id" width="180"></el-table-column>
...
export default {
  ...
  methods: {
    getStudentInfo() {
      ...
      outputStudent(){
          this.$confirm('将学生信息导出为excel文件，确认导出?','提示',{
              confirmButtonText:'确认',
              cancelButtonText:'取消',
              type:'warning'
          }).then(()=>{
              this.excelData = this.pagination.records;
              this.export2Excel();
          }).catch(()=>{
      ...
      export2Excel(){
          ...
          require.ensure([],()=>{
              ...
              const tHeader = ['学生Id','学生姓名','年级','专业','班级','所属学院','电话','邮箱','密码','性别'];
              const filterVal = ['studentId','studentName','grade','major','clazz','institute','tel','email','pwd','sex'];
