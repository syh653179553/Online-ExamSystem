      ...
      <el-tab-pane name="first">
        ...
        <section class="append">
          <ul>
            ...
            <li>
              <span>科目:</span>
              <el-select v-model="subject" placeholder="请选择题型" class="w150">
                <el-option
    ...
    export default {
        ...
        methods: {
            ...
            changeSubmit() { //选择题题库提交
                ...
                this.postChange.questionsSetter = this.userName
            ...
            fillSubmit() { //填空题提交
                ...
                this.postFill.questionsSetter = this.userName
            ...
            judgeSubmit() { //判断题提交
                ...
                this.postJudge.questionsSetter = this.userName
                this.$axios({
