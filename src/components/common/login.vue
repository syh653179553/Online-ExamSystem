  ...
  <div id="login">
    ...
    <el-row class="main-container">
      <el-col :lg="8" :xs="16" :md="10" :span="10">
        <div class="top">
          <i class="iconfont el-icon-edit"></i><span class="title">在线考试系统</span>
        </div>
        <div class="bottom">
          <div class="container">
    ...
    <el-row class="footer">
      <el-col>
        <p class="msg2">版权所有 ©2020  保留所有权利 苏ICP备00000000号</p>
      </el-col>
    </el-row>
...
#login .bg {
  ...
  overflow-y: auto;
  height: 100%;
  background: url('../../assets/img/loginbg2.jpg')center top / cover no-repeat;
