...
<template>
  <div class="all">
    <el-button type="primary" size="small" @click="outputTeacher">导出</el-button>
    <br>
    <br>
...
export default {
  ...
  methods: {
    ...
    checkGrade(teacherId) { //修改教师信息
      ...
      outputTeacher(){
          this.$confirm('将教师信息导出为excel文件，确认导出?','提示',{
      ...
      export2Excel(){
          ...
          require.ensure([],()=>{
              ...
              const tHeader = ['教师Id','教师姓名','所属学院','性别','电话','邮箱','密码','身份证号','职称'];
              const filterVal = ['teacherId','teacherName','institute','sex','tel','email','pwd','cardId','type'];
              const list = that.excelData;
              const data = that.formatJson(filterVal,list);
              export_json_to_excel(tHeader,data,'教师信息')
          });
      },
